...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "xIOrHkmqFClGZI22OlphugGR4", consumerSecret: "tmea60duIDiWrnjnybsylZEUgZJLqbgQOjKO2FhGV3UP6HQjWw")
    var loginSuccess: (() -> ())?
